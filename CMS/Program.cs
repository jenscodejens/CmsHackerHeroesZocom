...
namespace CMS
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                connectionString = builder.Configuration.GetConnectionString("DefaultConnectionMacOS");
            }
            else
            {
            ...
            {
                throw new InvalidOperationException("Connection string not found for the current OS.");
            }
